## Проект больше не поддерживается и не рекомендуется к использованию

Куда лучше использовать [Docker](https://www.docker.com/), где имеется множество [готовых контейнеров](https://registry.hub.docker.com/search?q=library)
